...
public class QuestionDialogueUI2 : MonoBehaviour
{
    ...
    private void Awake(){
        ...
        ShowQuestion("<div style=100px;bottom:300px;color:[___]></div> \r\n <div style=100px;bottom:300px;color:[___]></div>", () => {
            Debug.Log("Correct");
        }, () => {
            Debug.Log("Wrong");
        });
    ...
    public void GravarFicheiro(string resp)
    {
        ...
        {  
            writer.WriteLine(resp + "2|" + DateTime.Now.ToString());  
            writer.Close();
        } 
    }
